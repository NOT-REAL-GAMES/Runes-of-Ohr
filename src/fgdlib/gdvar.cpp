...
{
	{ ivAngle,				(char*)"angle",				STRING },
	{ ivChoices,			(char*)"choices",				STRING },
	{ ivColor1,				(char*)"color1",				STRING },
	{ ivColor255,			(char*)"color255",				STRING },
	{ ivDecal,				(char*)"decal",				STRING },
	{ ivFlags,				(char*)"flags",				INTEGER },
	{ ivInteger,			(char*)"integer",				INTEGER },
	{ ivSound,				(char*)"sound",				STRING },
	{ ivSprite,				(char*)"sprite",				STRING },
	{ ivString,				(char*)"string",				STRING },
	{ ivStudioModel,		(char*)"studio",				STRING },
	{ ivTargetDest,			(char*)"target_destination",	STRING },
	{ ivTargetSrc,			(char*)"target_source",		STRING },
	{ ivTargetNameOrClass,	(char*)"target_name_or_class",	STRING },	// Another version of target_destination that accepts class names
	{ ivVector,				(char*)"vector",				STRING },
	{ ivNPCClass,			(char*)"npcclass",				STRING },
	{ ivFilterClass,		(char*)"filterclass",			STRING },
	{ ivFloat,				(char*)"float",				STRING },
	{ ivMaterial,			(char*)"material",				STRING },
	{ ivScene,				(char*)"scene",				STRING },
	{ ivSide,				(char*)"side",					STRING },
	{ ivSideList,			(char*)"sidelist",				STRING },
	{ ivOrigin,				(char*)"origin",				STRING },
	{ ivAxis,				(char*)"axis",					STRING },
	{ ivVecLine,			(char*)"vecline",				STRING },
	{ ivPointEntityClass,	(char*)"pointentityclass",		STRING },
	{ ivNodeDest,			(char*)"node_dest",			INTEGER },
	{ ivScript,				(char*)"script",				STRING },
	{ ivScriptList,			(char*)"scriptlist",			STRING },
	{ ivInstanceFile,		(char*)"instance_file",		STRING },
	{ ivAngleNegativePitch,	(char*)"angle_negative_pitch",	STRING },
	{ ivInstanceVariable,	(char*)"instance_variable",	STRING },
	{ ivInstanceParm,		(char*)"instance_parm",		STRING },
};


char *GDinputvariable::m_pszEmpty = (char*)"";
